...
struct PartitionConfig
{
	...
	bool disable_label_propagation;
	bool disable_quotient_refinement;
	bool disable_fm_multitry;
	bool disable_kway_fm;
        int analyzer_mode;
	std::vector<std::string> input_filenames;
        bool force_new_initial_partitioning; 
        bool block_cut_edges_only_in_first_level; 
        std::string input_partition2;
	int *input_assignments;
	int *input_assignments2;
