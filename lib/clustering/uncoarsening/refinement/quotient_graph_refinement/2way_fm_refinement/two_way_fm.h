...
#include "clustering/uncoarsening/refinement/quotient_graph_refinement/two_way_refinement.h"
...
class two_way_fm : public two_way_refinement {
        ...
        private:
                ...
                inline bool is_boundary_node(graph_access & G,
                                 const NodeID & node,
                                 const PartitionID lhs,
                                 const PartitionID rhs);
...
inline bool two_way_fm::is_boundary_node(graph_access & G,
                const NodeID & node,
                const PartitionID lhs,
                const PartitionID rhs) {
